...
export const BLOCKS: Record<BlockType, BlockDefinition> = {
  heroEditorial: {
    type: "heroEditorial",
    name: L("الواجهة التحريرية (لوحة معمارية)", "Editorial hero (drafting sheet)"),
    description: L("عنوان ضخم مع كلمة مفرّغة، صور متراكبة، شريط أرقام كخط أبعاد", "Oversized headline with an outlined line, layered photos and a dimension-line stats bar"),
    icon: "Sparkles",
    category: "hero",
    fields: [
      { key: "eyebrow", type: "ltext", label: L("سطر تعريفي صغير", "Small intro line") },
      { key: "title", type: "ltextarea", label: L("العنوان الرئيسي — كل سطر في صف", "Headline — one line per row"), help: L("اكتب 2–3 أسطر قصيرة", "Write 2–3 short lines") },
      {
        key: "outlineLine",
        type: "select",
        label: L("السطر المفرّغ (بدون تعبئة)", "Outlined line"),
        width: "half",
        options: [
          { value: "0", label: L("بدون", "None") },
          { value: "1", label: L("السطر الأول", "First line") },
          { value: "2", label: L("السطر الثاني", "Second line") },
          { value: "3", label: L("السطر الثالث", "Third line") },
        ],
      },
      { key: "subtitle", type: "ltextarea", label: L("النص التعريفي", "Intro paragraph") },
      ...linkFields,
      { key: "mainMedia", type: "media", accept: "any", label: L("الصورة الرئيسية (طولية)", "Main photo (portrait crop)") },
      { key: "secondaryMedia", type: "media", accept: "image", label: L("صورة ثانية متراكبة (اختياري)", "Overlapping second photo (optional)") },
      { key: "mediaCaption", type: "ltext", label: L("تعليق الصورة (مثل: مشروع — الموقع — السنة)", "Photo caption (e.g. project — location — year)") },
      {
        key: "stats",
        type: "list",
        label: L("شريط الأرقام (خط الأبعاد)", "Numbers bar (dimension line)"),
        itemFields: [
          { key: "value", type: "text", label: L("الرقم", "Value"), width: "half" },
          { key: "label", type: "ltext", label: L("الوصف", "Label") },
        ],
        newItem: () => ({ value: "10+", label: L("وصف", "Label") }),
        max: 4,
      },
      { key: "showScrollHint", type: "boolean", label: L("إشارة التمرير", "Scroll hint"), width: "half" },
    ],
    defaults: () => ({
      eyebrow: L("شركة كيب تاون للتجارة العامة والمقاولات — الكويت", "Cape Town General Trading & Contracting — Kuwait"),
      title: L("نبني\nبدقة\nتدوم.", "Precision\nbuilt into\nevery structure."),
      outlineLine: "2",
      subtitle: L(
        "من الحفر إلى التسليم — فلل ومباني سكنية وتجارية وحكومية، ينفّذها فريق هندسي واحد يتابع المخططات والتراخيص والتنفيذ.",
        "From excavation to handover — villas, residential, commercial and government buildings, delivered by one engineering team that handles drawings, permits and execution."
      ),
      buttons: [link("ابدأ مشروعك", "Start a project", "/contact", "primary", ""), link("شاهد أعمالنا", "See our work", "/projects", "ghost", "")],
      mainMedia: "/photos/hero-construction-site.jpg",
      secondaryMedia: "/photos/project-villa-jahra.jpg",
      mediaCaption: L("موقع عمل — الكويت — 2025", "Live site — Kuwait — 2025"),
      stats: [
        { value: "20+", label: L("سنة خبرة", "Years building") },
        { value: "150+", label: L("مشروع منجز", "Projects delivered") },
        { value: "300+", label: L("عميل", "Clients served") },
      ],
      showScrollHint: true,
    }),
    defaultStyle: { theme: "light", paddingY: "none", container: "default", showGrid: true, numbered: false, hairline: false, animation: "none" },
  },

  servicesIndex: {
    type: "servicesIndex",
    name: L("فهرس الخدمات (قائمة مرقّمة تفاعلية)", "Services index (interactive numbered list)"),
    description: L("قائمة كبيرة مرقّمة مع صورة تتغيّر عند التمرير وتوسّع للوصف", "Large numbered rows with a sticky image that changes on hover and expandable descriptions"),
    icon: "ListOrdered",
    category: "lists",
    fields: [
      ...
      { key: "limit", type: "number", label: L("الحد الأقصى", "Maximum count"), width: "half", min: 1, max: 24 },
      { key: "selected", type: "services", label: L("اختر الخدمات", "Choose services"), showIf: (v) => v.source === "selected" },
      { key: "showImages", type: "boolean", label: L("لوحة الصور الجانبية", "Side image plate"), width: "half" },
      { key: "showButton", type: "boolean", label: L("زر 'كل الخدمات'", "'All services' link"), width: "half" },
      { key: "buttonLabel", type: "ltext", label: L("نص الزر", "Link text"), showIf: (v) => v.showButton },
    ],
    defaults: () => ({
      eyebrow: L("الخدمات", "Services"),
      title: L("كل مرحلة من مشروعك، تحت سقف واحد", "Every stage of your project, under one roof"),
      subtitle: L("", ""),
      source: "all",
      limit: 8,
      selected: [],
    ...
    defaultStyle: { theme: "light", paddingY: "xl", numbered: true, showGrid: true, hairline: true, sideLabel: { ar: "الخدمات", en: "Services" } },
  },

  story: {
    type: "story",
    name: L("قصة الشركة (عرض تحريري)", "Company story (editorial)"),
    description: L("عبارة كبيرة، نص، صورتان متراكبتان، أرقام وإنجازات", "Big statement, body copy, two overlapping photos, numbers and achievements"),
    icon: "PanelsTopLeft",
    category: "content",
    fields: [
      { key: "eyebrow", type: "ltext", label: L("عنوان صغير", "Eyebrow") },
      { key: "statement", type: "ltextarea", label: L("العبارة الكبيرة", "Big statement") },
      { key: "body", type: "lrichtext", label: L("النص", "Body text") },
      { key: "imageA", type: "media", accept: "any", label: L("الصورة الكبيرة", "Large photo") },
      { key: "imageB", type: "media", accept: "image", label: L("الصورة الصغيرة المتراكبة", "Small overlapping photo") },
      { key: "imageCaption", type: "ltext", label: L("تعليق الصور", "Photo caption") },
      {
        key: "stats",
        type: "list",
        ...
        itemFields: [
          ...
          { key: "suffix", type: "text", label: L("لاحقة", "Suffix"), width: "half" },
          { key: "label", type: "ltext", label: L("الوصف", "Label") },
        ],
        newItem: () => ({ value: 10, suffix: "+", label: L("وصف", "Label") }),
        max: 4,
      },
      {
        key: "achievements",
        type: "list",
        label: L("الإنجازات / الاعتمادات", "Achievements / credentials"),
        itemFields: [{ key: "text", type: "ltext", label: L("النص", "Text") }],
        newItem: () => ({ text: L("إنجاز", "Achievement") }),
      },
      ...linkFields,
    ],
    defaults: () => ({
      eyebrow: L("من نحن", "About us"),
      statement: L("فريق واحد من أول حفرة حتى تسليم المفتاح.", "One team, from the first excavation to the final key handover."),
      body: L(
        "<p>شركة كيب تاون للتجارة العامة والمقاولات شركة كويتية تنفّذ جميع أعمال البناء: الأساسات والهيكل الإنشائي والتشطيب، حتى التسليم النهائي.</p><p>مكتبنا الهندسي يُعدّ المخططات ويتابع معاملات البلدية والتراخيص، ليحصل عميلنا على مشروع كامل من جهة واحدة — بجدول زمني واضح وضمان مكتوب.</p>",
        "<p>Cape Town General Trading & Contracting is a Kuwaiti company delivering complete construction works — foundations, structure and finishing — through to final handover.</p><p>Our in-house engineering office prepares the drawings and follows up municipality permits, so clients get a complete project from a single partner, with a published schedule and a written warranty.</p>"
      ),
      imageA: "/photos/about-engineers-site.jpg",
      imageB: "/photos/engineer-inspection.jpg",
      imageCaption: L("مراجعة المخططات في الموقع", "Reviewing drawings on site"),
      stats: [
        { value: 20, suffix: "+", label: L("سنة خبرة", "Years of experience") },
        { value: 150, suffix: "+", label: L("مشروع منجز", "Projects completed") },
        { value: 300, suffix: "+", label: L("عميل", "Clients") },
      ],
      achievements: [
        { text: L("مرخّصة من بلدية الكويت", "Licensed by Kuwait Municipality") },
        { text: L("مكتب هندسي داخلي", "In-house engineering office") },
        { text: L("ضمان مكتوب على جميع الأعمال", "Written warranty on all works") },
        { text: L("مهندسون معتمدون في الموقع", "Certified engineers on every site") },
      ],
      buttons: [link("تعرّف علينا", "More about us", "/about", "ghost", "")],
    }),
    defaultStyle: { theme: "light", paddingY: "xl", numbered: true, showGrid: true, hairline: true, sideLabel: { ar: "من نحن", en: "About" } },
  },

  capabilities: {
    type: "capabilities",
    name: L("ماذا نبني (قائمة تحريرية)", "What we build (editorial list)"),
    description: L("قائمة أنواع المباني بخطوط فاصلة رفيعة", "Building types as a hairline list"),
    icon: "LayoutGrid",
    category: "content",
    fields: [
      { key: "eyebrow", type: "ltext", label: L("عنوان صغير", "Eyebrow") },
      { key: "title", type: "ltext", label: L("العنوان", "Title") },
      {
        ...
        newItem: () => ({ title: L("نوع", "Type"), text: L("", ""), href: "" }),
      },
    ],
    defaults: () => ({
      eyebrow: L("ماذا نبني", "What we build"),
      title: L("سكني، تجاري، حكومي — بنفس المعيار.", "Residential, commercial, government — one standard."),
      items: [
        { title: L("فلل خاصة", "Private villas"), text: L("تصميم وبناء وتشطيب كامل حتى المفتاح", "Design, build and full finishing to key handover"), href: "/projects" },
        { title: L("مباني سكنية", "Residential buildings"), text: L("بيوت وأدوار سكنية", "Houses and residential floors"), href: "/projects" },
        { title: L("عمارات استثمارية", "Apartment buildings"), text: L("هيكل، واجهات، مصاعد وخدمات", "Structure, façades, lifts and services"), href: "/projects" },
        { title: L("مباني تجارية", "Commercial buildings"), text: L("محلات ومجمعات ومكاتب", "Shops, complexes and offices"), href: "/projects" },
        { title: L("مشاريع حكومية", "Government projects"), text: L("تنفيذ وفق مواصفات الجهات الرسمية", "Executed to official specifications"), href: "/projects" },
      ],
    }),
    defaultStyle: { theme: "dark", paddingY: "xl", numbered: true, showGrid: true, hairline: false, sideLabel: { ar: "أنواع المباني", en: "Building types" }, background: { type: "color", color: "#10142b", gradientFrom: "", gradientTo: "", gradientAngle: 0, mediaUrl: "", mobileVideoUrl: "", videoOnMobile: false, posterUrl: "", overlayColor: "", overlayOpacity: 0, overlayStyle: "solid", parallax: false, pattern: "grid" } },
  },

  portfolio: {
    type: "portfolio",
    name: L("معرض الأعمال (لوحات معمارية)", "Portfolio (architectural plates)"),
    description: L("مشروع مميز بعرض كامل ثم شبكة متدرجة بأحجام مختلفة، وتمرير أفقي على الجوال", "One full-width featured project, then a staggered layout of different plate sizes; swipe carousel on phones"),
    icon: "Building2",
    category: "lists",
    fields: [
      ...sectionHeadingFields(),
      ...
      { key: "limit", type: "number", label: L("الحد الأقصى", "Maximum count"), width: "half", min: 1, max: 60 },
      ...
      { key: "featuredFirst", type: "boolean", label: L("أول مشروع بعرض كامل", "First project full-width"), width: "half" },
      { key: "showButton", type: "boolean", label: L("زر 'كل الأعمال'", "'All projects' link"), width: "half" },
      { key: "buttonLabel", type: "ltext", label: L("نص الزر", "Link text"), showIf: (v) => v.showButton },
    ],
    defaults: () => ({
      eyebrow: L("أعمالنا", "Selected work"),
      title: L("مشاريع تتحدث عن نفسها", "Projects that speak for themselves"),
      subtitle: L("", ""),
      source: "featured",
      limit: 6,
      category: "",
    ...
    defaultStyle: { theme: "light", paddingY: "xl", numbered: true, showGrid: true, hairline: true, sideLabel: { ar: "الأعمال", en: "Projects" } },
  },

  principles: {
    type: "principles",
    name: L("مبادئنا (قائمة مرقّمة)", "Principles (numbered manifesto)"),
    description: L("لماذا نحن — عبارات مرقّمة بدون أيقونات", "Why us — numbered statements, no icons"),
    icon: "BadgeCheck",
    category: "content",
    fields: [
      { key: "eyebrow", type: "ltext", label: L("عنوان صغير", "Eyebrow") },
      { key: "title", type: "ltextarea", label: L("العبارة الكبيرة", "Big statement") },
      {
        key: "items",
        type: "list",
        ...
        newItem: () => ({ title: L("مبدأ", "Principle"), text: L("", "") }),
      },
    ],
    defaults: () => ({
      eyebrow: L("لماذا كيب تاون", "Why Cape Town"),
      title: L("ما يميّزنا لا يُقال — يُقاس في الموقع.", "What sets us apart isn't said. It's measured on site."),
      items: [
        { title: L("الدقة", "Precision"), text: L("نلتزم بالمخططات والمواصفات حرفياً، ونراجع كل مرحلة قبل الانتقال للتي تليها.", "We follow drawings and specifications to the letter and review every stage before moving on.") },
        { title: L("السرعة", "Speed"), text: L("جداول زمنية معلنة وفرق عمل متعددة تسلّم مشروعك في موعده.", "Published schedules and multiple crews deliver your project on time.") },
        { title: L("الخبرة", "Experience"), text: L("سنوات في السوق الكويتي أكسبتنا معرفة دقيقة بالمواد والجهات والإجراءات.", "Years in the Kuwaiti market gave us exact knowledge of materials, authorities and procedures.") },
        { title: L("مكتب هندسي", "Engineering office"), text: L("نُعدّ المخططات ونتابع الاعتمادات والتراخيص بأنفسنا.", "We prepare the drawings and follow up approvals and permits ourselves.") },
        { title: L("الضمان", "Warranty"), text: L("عقود واضحة وضمان مكتوب على الأعمال المنفذة.", "Clear contracts and a written warranty on executed works.") },
        { title: L("تعامل مباشر", "Direct relationship"), text: L("تتعامل مع فريقنا مباشرة دون وسطاء، بأسعار واضحة من البداية.", "You deal with our team directly, with transparent pricing from day one.") },
      ],
    }),
    defaultStyle: { theme: "light", paddingY: "xl", numbered: true, showGrid: true, hairline: true, sideLabel: { ar: "المبادئ", en: "Principles" } },
  },

  startProject: {
    type: "startProject",
    name: L("ابدأ مشروعك (تواصل + نموذج)", "Start a project (contact panel)"),
    description: L("عنوان كبير مع رقم الهاتف والواتساب ونموذج مختصر", "Big headline with phone, WhatsApp and a compact form"),
    icon: "PhoneCall",
    category: "conversion",
    fields: [
      { key: "eyebrow", type: "ltext", label: L("عنوان صغير", "Eyebrow") },
      { key: "title", type: "ltextarea", label: L("العنوان", "Headline") },
      { key: "text", type: "ltextarea", label: L("النص", "Text") },
      { key: "showForm", type: "boolean", label: L("إظهار النموذج", "Show form"), width: "half" },
      { key: "showInfo", type: "boolean", label: L("العنوان وساعات العمل", "Address & hours"), width: "half" },
      { key: "showServiceSelect", type: "boolean", label: L("حقل الخدمة", "Service field"), width: "half" },
      { key: "showEmailField", type: "boolean", label: L("حقل البريد", "Email field"), width: "half" },
      {
        key: "formMode",
        type: "select",
        ...
        options: [
          ...
          { value: "whatsapp", label: L("واتساب", "Open WhatsApp") },
          { value: "both", label: L("الاثنان", "Both") },
        ],
      },
      { key: "buttonLabel", type: "ltext", label: L("نص زر الإرسال", "Submit button text") },
    ],
    defaults: () => ({
      eyebrow: L("تواصل معنا", "Get in touch"),
      title: L("لنبنِ شيئاً\nيدوم.", "Let's build\nsomething that lasts."),
      text: L("أخبرنا عن مشروعك — قطعة أرض، فيلا، عمارة أو مبنى تجاري — وسيعاينه مهندس من فريقنا ويقدّم عرضاً واضحاً.", "Tell us about your project — a plot, a villa, a building or a commercial space — and one of our engineers will survey it and prepare a clear proposal."),
      showForm: true,
      showInfo: true,
      showServiceSelect: true,
      showEmailField: false,
      formMode: "both",
      buttonLabel: L("أرسل الطلب", "Send request"),
    }),
    defaultStyle: { theme: "light", paddingY: "xl", numbered: true, showGrid: true, hairline: true, sideLabel: { ar: "تواصل", en: "Contact" } },
  },
  ...
  hero: {
    ...
    defaults: () => ({
      ...
      height: "lg",
      eyebrow: L("", ""),
      title: L("نبني بدقة، ونسلّم في الوقت.", "We build with precision, and deliver on time."),
      subtitle: L(
        "شركة مقاولات كويتية تنفّذ الفلل والمباني السكنية والتجارية من الحفر حتى تسليم المفتاح.",
        "A Kuwaiti contracting company delivering villas, residential and commercial buildings — from excavation to key handover."
      ),
      buttons: [link("ابدأ مشروعك", "Start your project", "/contact", "primary", "")],
      sideMedia: "",
      badges: [],
  ...
  pageHeader: {
    ...
    defaultStyle: {
      ...
      align: "start",
      showGrid: true,
      background: { type: "gradient", color: "#233283", gradientFrom: "#233283", gradientTo: "#0f172a", gradientAngle: 135, mediaUrl: "", mobileVideoUrl: "", videoOnMobile: false, posterUrl: "", overlayColor: "#0b1244", overlayOpacity: 60, overlayStyle: "solid", parallax: false, pattern: "grid" },
    },
  },
  ...
  about: {
    ...
    defaults: () => ({
      ...
      mediaPosition: "start",
      mediaStyle: "rounded",
      badge: { show: true, value: "20+", label: L("سنة من الخبرة", "Years of experience") },
    }),
  },
  ...
  services: {
    ...
    defaultStyle: { background: { type: "none", color: "", gradientFrom: "", gradientTo: "", gradientAngle: 135, mediaUrl: "", mobileVideoUrl: "", videoOnMobile: false, posterUrl: "", overlayColor: "", overlayOpacity: 0, overlayStyle: "solid", parallax: false, pattern: "grid" } },
  },
  ...
  projects: {
    ...
    fields: [
      ...
      { key: "mobileLayout", type: "select", label: L("العرض على الجوال", "Phone layout"), width: "half", options: [{ value: "swipe", label: L("تمرير أفقي", "Swipe row") }, { value: "stacked", label: L("قائمة عمودية", "Stacked list") }] },
  ...
  stats: {
    ...
    defaultStyle: {
      theme: "dark",
      paddingY: "md",
      background: { type: "color", color: "#233283", gradientFrom: "#233283", gradientTo: "#17205c", gradientAngle: 90, mediaUrl: "", mobileVideoUrl: "", videoOnMobile: false, posterUrl: "", overlayColor: "", overlayOpacity: 0, overlayStyle: "solid", parallax: false, pattern: "grid" },
    },
  },
  ...
  cta: {
    ...
    defaultStyle: {
      theme: "dark",
      paddingY: "lg",
      background: { type: "image", color: "#233283", gradientFrom: "", gradientTo: "", gradientAngle: 135, mediaUrl: "/photos/kuwait-skyline-sunset.jpg", mobileVideoUrl: "", videoOnMobile: false, posterUrl: "", overlayColor: "#0b1244", overlayOpacity: 82, overlayStyle: "solid", parallax: false, pattern: "grid" },
    },
  },
  ...
  marquee: {
    ...
    defaultStyle: { paddingY: "none", container: "full", theme: "light", background: { type: "none", color: "", gradientFrom: "", gradientTo: "", gradientAngle: 0, mediaUrl: "", mobileVideoUrl: "", videoOnMobile: false, posterUrl: "", overlayColor: "", overlayOpacity: 0, overlayStyle: "solid", parallax: false, pattern: "grid" } },
  },
...
export const BLOCK_ORDER: BlockType[] = ["hero", "pageHeader", "about", "services", "projects", "stats", "cta", "heroEditorial", "servicesIndex", "story", "capabilities", "portfolio", "principles", "startProject", "buildingTypes", "features", "steps", "testimonials", "partners", "faq", "team", "gallery", "video", "image", "richText", "contact", "map", "marquee", "spacer", "html"];
...
export const DEFAULT_STYLE: BlockStyle = {
  ...
  hairline: false,
  theme: "light",
  background: { type: "none", color: "#ffffff", gradientFrom: "#233283", gradientTo: "#0f172a", gradientAngle: 135, mediaUrl: "", mobileVideoUrl: "", videoOnMobile: false, posterUrl: "", overlayColor: "#0b1244", overlayOpacity: 60, overlayStyle: "solid", parallax: false, pattern: "grid" },
  textColor: "",
  headingColor: "",
  accentColor: "",
  paddingY: "lg",
...
export const STYLE_FIELDS: Field[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "posterUrl", type: "media", accept: "image", label: L("صورة بديلة (تظهر قبل التشغيل وعلى الجوال)", "Poster image (shown before playback and on phones)"), showIf: (v) => v.type === "video" },
      { key: "videoOnMobile", type: "boolean", label: L("تشغيل الفيديو على الجوال أيضاً", "Also play the video on phones"), showIf: (v) => v.type === "video", help: L("عند الإيقاف تظهر الصورة البديلة على الجوال لتوفير البيانات. الفيديو لا يعمل تلقائياً في وضع توفير الطاقة على آيفون", "When off, phones show the poster image to save data. iPhones in Low Power Mode always show the poster") },
      { key: "mobileVideoUrl", type: "media", accept: "video", label: L("نسخة أخف للجوال (اختياري)", "Lighter version for phones (optional)"), showIf: (v) => v.type === "video" && v.videoOnMobile },
  ...
  { key: "sideLabel", type: "ltext", label: L("تسمية جانبية عمودية (شاشات كبيرة)", "Vertical margin label (large screens)") },
  { key: "numbered", type: "boolean", label: L("رقم القسم في الزاوية", "Sheet number in the corner"), width: "half" },
  { key: "showGrid", type: "boolean", label: L("خطوط الشبكة المعمارية", "Drafting grid lines"), width: "half" },
  { key: "hairline", type: "boolean", label: L("خط فاصل رفيع أعلى القسم", "Hairline rule above the section"), width: "half" },
